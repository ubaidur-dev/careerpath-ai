  ...
  return (
    <div className="min-h-screen bg-white flex flex-col lg:flex-row relative font-poppins overflow-hidden">
      ...
      <div 
        ...
        className={`w-full lg:w-[55%] flex flex-col justify-center items-center px-8 sm:px-16 lg:px-24 py-12 h-screen overflow-y-auto ${isLogin ? 'order-1' : 'order-2'}`}
      >
        <div className="w-full max-w-[420px] space-y-6">
          ...
          <div className="text-center space-y-2 mt-[220px]">
          ...
          {isLogin && (
            <div className="flex bg-gray-100/80 p-1.5 rounded-full items-center w-[320px] mx-auto border border-gray-200 mt-[40px]">
              <button
                type="button"
          ...
          <form onSubmit={handleFormSubmit} className={`space-y-5 ${isLogin ? '' : 'mt-[58px]'}`}>
            {!isLogin && (
            ...
            <button 
              type="submit" 
              className="w-full bg-[#ffa3f5] hover:bg-[#f88def] text-[#890080] font-medium py-3.5 rounded-full text-[18px] tracking-wider transition-all shadow-sm mt-4 cursor-pointer"
            >
          ...
          <div className="relative flex items-center justify-center py-2">
            ...
            <span className="relative bg-white px-4 text-[16px] font-normal text-gray-500 lowercase tracking-widest">or continue with</span>
          </div>
