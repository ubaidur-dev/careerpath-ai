    ...
    <header className="w-full bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between sticky top-0 z-40 shadow-3xs">
      <div className="flex items-center gap-2 cursor-pointer" onClick={() => onNavigate('dashboard')}>
        <div className="w-9 h-9 bg-pink-50 rounded-xl flex items-center justify-center border border-pink-100">
          <svg className="w-5 h-5 text-[#db2777]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
          </svg>
        </div>
        <span className="font-sans font-black text-xl tracking-tight bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
          CareerPath<span className="text-[#db2777]">AI</span>
        </span>
      </div>
      ...
      <div className="flex items-center gap-4">
        <button 
          onClick={onLogout}
          className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-gray-500 hover:text-red-600 hover:bg-red-50/50 rounded-xl transition-all cursor-pointer"
        >
            ...
            <div className="bg-white rounded-3xl max-w-xl w-full p-7 relative shadow-2xl border border-gray-100">
              ...
              <div className="mb-7">
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="bg-blue-50/60 border border-blue-100 px-4 py-3.5 rounded-xl flex items-xl justify-between">
